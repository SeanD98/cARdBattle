...
public class DemonBattlescript : MonoBehaviour
{
    public static DemonBattlescript instance;
    ...
    public float currentValue = 1000.0f;
    ...
    void SwapScene()
    {
        Analytics.CustomEvent("Battle - Demons - Ended. Player: " + Outcome);
