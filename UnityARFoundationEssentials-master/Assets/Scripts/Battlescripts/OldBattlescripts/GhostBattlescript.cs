...
public class GhostBattlescript : MonoBehaviour
{
    public static GhostBattlescript instance;
    ...
    public static int DamageDelt = 0;
    ...
    void SwapScene()
    {
        Analytics.CustomEvent("Battle - Ghosts - Ended. Player: " + Outcome);
