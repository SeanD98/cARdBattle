...
{
    public static MonsterBattlescript instance;
    ...
    public void Attack()
    {
        ...
        EnemyHealth = EnemyHealth - mySocketScript.instance.DamageTaken;
    ...
    void SwapScene()
    {
        Analytics.CustomEvent("Battle - Monster - Ended. Player: " + Outcome);
