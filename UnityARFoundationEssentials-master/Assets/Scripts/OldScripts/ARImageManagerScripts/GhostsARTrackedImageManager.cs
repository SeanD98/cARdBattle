...
public class GhostsARTrackedImageManager : MonoBehaviour
{
    [SerializeField]
    ...
    void Update()
    {
        if (Input.touchCount > 0)
        {
            ...
            if (touch.phase == TouchPhase.Stationary)
            {
                ...
                {
                    if (hitObject.transform.name == "MonsterAROne")
                    {
                        SceneManager.LoadScene("GhostBattleScene");
                    }
                    if (hitObject.transform.name == "MonsterARTwo")
                    {
                        SceneManager.LoadScene("GhostBattleScene");
                    }
                    if (hitObject.transform.name == "MonsterARThree")
                    {
                        SceneManager.LoadScene("GhostBattleScene");
                    }
                    if (hitObject.transform.name == "MonsterARFour")
                    {
                        SceneManager.LoadScene("GhostBattleScene");
                    }
